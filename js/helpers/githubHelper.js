define([
    ...
    function authenticate(task) {
        ...
        task.onRun(function() {
            ...
            function getToken() {
                $.getJSON('https://github.com/login/oauth/access_token?client_id=944e39c86a2b53564ac1&client_secret=11111111111111111111111111111111&code='+code, function(data) {
